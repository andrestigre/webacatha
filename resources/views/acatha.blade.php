...
<head>
    ...
    {{--
    <link href="{{ asset('acatha/font-awesome-4.7.0/css/fontawesome.min.css') }}" rel="stylesheet">
        --}}
    <link rel="stylesheet" href="{{ asset('acatha/fontawesome/web-fonts-with-css/css/fontawesome-all.min.css') }}">
