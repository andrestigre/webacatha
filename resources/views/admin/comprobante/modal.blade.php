           ...
           <div class="modal-header">
            ...
            <div class="modal-body">
                ...
                <form method="POST" id="formitrmcomprobante" action="{{ url('/admin/storeitemcomp') }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="form-group {{ $errors->has('alinear') ? 'has-error' : ''}}">
    <label for="alinear" class="col-md-4 control-label">{{ 'Alinear' }}</label>
    <div class="col-md-6">
        <div class="radio">
    <label>
        <input name="alinear" type="radio" value="0" > Derecha</label>
</div>
<div class="radio">
    <label>
        <input name="alinear" type="radio" value="1" checked> Izquierda</label>
</div>
        {!! $errors->first('alinear', '<p class="help-block">:message</p>') !!}
    </div>
</div>
...
<div class="modal fade" id="updateItemCaracteristica" tabindex="-1" role="dialog" aria-labelledby="UpdateItemCrtModalLabel">
    ...
    <div class="col-md-6">
        <div class="radio">
    <label>
        <input name="alinear" id="alinearmod" type="radio" value="0" > Derecha</label>
</div>
<div class="radio">
    <label>
        <input name="alinear" id="alinearmod" type="radio" value="1" checked> Izquierda</label>
</div>
        {!! $errors->first('alinear', '<p class="help-block">:message</p>') !!}
    </div>
</div>
...
<div class="modal fade" id="viewItemCaracteristica" tabindex="-1" role="dialog" aria-labelledby="ViewItemCrtModalLabel">
    ...
    <div class="col-md-6">
        <div class="radio">
    <label>
        <input name="alinear" id="alinearv" type="radio" value="0" > Derecha</label>
</div>
<div class="radio">
    <label>
        <input name="alinear" id="alinearv" type="radio" value="1" checked> Izquierda</label>
</div>
        {!! $errors->first('alinear', '<p class="help-block">:message</p>') !!}
    </div>
</div>
