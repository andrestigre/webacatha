            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <a href="{{ url('/admin/empresa/create') }}" class="btn btn-success btn-sm" title="Add New Empresa">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>#</th><th>Empresa</th><th>Descripción</th><th>Telefono</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($empresa as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->empresa }}</td><td>{{ $item->descripcion }}</td><td>{{ $item->telefono }}</td>
                                        <td>
